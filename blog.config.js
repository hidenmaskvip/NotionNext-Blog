...
// 3.14.1版本后，欢迎语在此配置，英文逗号隔开 ,  即可支持多个欢迎语打字效果。
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到我的博客,一起理解这个社会🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hidden Watcher', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个爱折腾的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/hidenmaskvip', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '政治, 经济, 科技, 历史', // 网站关键词 英文逗号隔开
